...
### 2.1. Changing the types of values
//Content

### 2.2. List duplicate data and count number of duplicate data.
//Content

### 2.3.Removing duplicate data and reassign value in sat_score variable
//Content

### 2.4.Check range value of each score by using filter
//Content

### 2.5.Handling out of range with NA value
//Content

### 2.6.Calculate total score and assign in sum_score column
//Content
