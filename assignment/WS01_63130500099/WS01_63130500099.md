...
### My Step
-1. [Define a question](#Define-a-question)
0. [Loading Library and dataset](#Step-0:-Loading-library-and-dataset)
1. xxxxxxx
...
## Step 4: Removing duplicate data and reassign value in sat_score variable
...
## Step 5: How many distinct school in this dataset ? (Know after drop duplicate data)
